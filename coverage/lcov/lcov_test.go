...
var sampleProfiles = []*cover.Profile{
	{
		...
		Blocks: []cover.ProfileBlock{
			{NumStmt: 1, StartLine: 30, EndLine: 30, Count: 84},
			{NumStmt: 1, StartLine: 31, EndLine: 31, Count: 28},
			{NumStmt: 1, StartLine: 32, EndLine: 32, Count: 56},
			{NumStmt: 1, StartLine: 34, EndLine: 34, Count: 56},
			{NumStmt: 1, StartLine: 42, EndLine: 42, Count: 0},
			{NumStmt: 1, StartLine: 45, EndLine: 45, Count: 28},
			{NumStmt: 1, StartLine: 48, EndLine: 48, Count: 28},
			{NumStmt: 1, StartLine: 52, EndLine: 52, Count: 12},
			{NumStmt: 1, StartLine: 54, EndLine: 54, Count: 16},
			{NumStmt: 1, StartLine: 58, EndLine: 58, Count: 28},
			{NumStmt: 1, StartLine: 62, EndLine: 62, Count: 16},
		},
	},
	{
		...
		Mode:     "set",
		Blocks: []cover.ProfileBlock{
			{NumStmt: 1, StartLine: 33, EndLine: 33, Count: 230},
			{NumStmt: 1, StartLine: 36, EndLine: 36, Count: 479},
			{NumStmt: 1, StartLine: 37, EndLine: 37, Count: 236},
			{NumStmt: 1, StartLine: 38, EndLine: 38, Count: 51},
		},
	},
}
